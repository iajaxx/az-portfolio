...
function mFrames(w1,h1,w2,h2,ml2,w3,h3,w4,h4,ml4,w5,h5,ax5,ay5,w6,h6,o1,o2,o3,o4,o5,o6) {
	...
	$(".brandstory-home-frame-2").animate({"width": w2+"px", "height": h2+"px", "margin-right": ml2+"px"},{duration: d, easing: e});
	$(".brandstory-home-frame-3").animate({"width": w3+"px", "height": h3+"px"},{duration: d, easing: e});
	$(".brandstory-home-frame-4").animate({"width": w4+"px", "height": h4+"px", "margin-right": ml4+"px"},{duration: d, easing: e});
	$(".brandstory-home-frame-5").animate({"width": w5+"px", "height": h5+"px", "right": ax5+"px", "bottom": ay5+"px"},{duration: d, easing: e});
...
$(document).ready(function() {
	...
	$('.overlay').nivoLightbox({
		...
		onInit: function(){},
		beforeShowLightbox: function(){ if ($("#aside-box-video-list").length) { $(".vid-" + vHref).attr('href','../template-video-player/video-player.html?video=' + vHref); } },
		afterShowLightbox: function () { if ($("#aside-box-video-list").length) { $(".vid-" + vHref).attr('href','http://video.motorolasolutions.com/video.aspx/id/' + vHref); dcsMultiTrack('WT.ti', 'Video for ' + pTitle + ' for ' + vTitle + ' Load', 'DCSext.action', 'Video;' + pTitle + ';' + vTitle + ';1 - Load', 'WT.si_n','Video Completion Scenario','WT.si_x','2', 'WT.si_cs','1','WT.dl','99','DCSext.linkname', ' + vTitle + ' ,'WT.nv','Video','WT.clip_ev','v','WT.clip_n',' + vTitle + ','WT.clip_t','Video'); } },
